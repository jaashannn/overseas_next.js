import { destinationweddingsData } from "@/data/data";

export default function BusToursPage() {
  const { consolidators } = destinationweddingsData;

  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-6">Bus Tours Consolidators</h1>
